...
public class ScoreResourse {
	...
	@PostMapping
	public ResponseEntity<Score> save(@RequestBody ScoreDTO scoreDTO){
		return ResponseEntity.ok(scoreService.save(scoreDTO));
	}
	
	@GetMapping("/listdto")
	public ResponseEntity <List<ScoreDTO>> findAllDTO(){
